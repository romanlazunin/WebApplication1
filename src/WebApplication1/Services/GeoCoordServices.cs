...
namespace WebApplication1.Services
{
    public class GeoCoordServices
    {
        ...
        private ILogger<GeoCoordServices> _logger;

        public GeoCoordServices(ILogger<GeoCoordServices> logger,
        ...
        public async Task<GeoCoordResult> GetCoordsAsync(string name)
        {
